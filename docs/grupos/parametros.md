...
Este grupo foca em requisitos de **parametrização**: como o BI define valores padrão e variáveis institucionais para padronizar consultas, relatórios e dashboards.
